...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SealFile :  IEquatable<SealFile>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="SealFile" /> class.
        /// Initializes a new instance of the <see cref="SealFile" />class.
        /// </summary>
        /// <param name="ImagePngBase64">ImagePngBase64.</param>

        public SealFile(string ImagePngBase64 = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SealFile);
        }

        /// <summary>
        /// Returns true if SealFile instances are equal
        /// </summary>
        /// <param name="other">Instance of SealFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SealFile other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
